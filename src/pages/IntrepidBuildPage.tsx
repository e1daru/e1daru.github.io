...
const donutColors = ["#0ea5e9", "#3f3f46"];
            ...
            <div className="md:col-span-7">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 rounded-xl border-2 border-zinc-700 bg-zinc-900 px-6 py-3 text-base font-medium text-zinc-100 shadow-sm hover:bg-zinc-800/50 hover:border-zinc-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-400 transition"
                >
      ...
      <section className="page-center mt-16 grid gap-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="relative h-16 rounded bg-zinc-800/50 my-8">
              <div
                style={{
                  width: `${
              ...
              <div
                ...
                className="absolute -top-5 text-sm text-zinc-300"
              >
                Median $83k
              </div>
              <div
                ...
                className="absolute -bottom-5 text-sm font-medium text-cyan-400"
              >
                Needed ~$136k
              </div>
            </div>
          ...
          <div className="h-80">
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={unitEconomics} margin={chartMargin}>
                ...
                <Tooltip contentStyle={{ background: '#111118', border: '1px solid #27272a', color: '#e4e4e7' }} />
                <Legend wrapperStyle={legendStyle} />
                <Bar dataKey="Before" fill="#3f3f46" radius={[6, 6, 0, 0]} />
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <YAxis
                  ...
                  tick={{ fontSize: 12, fill: '#a1a1aa' }}
                />
                <Tooltip formatter={(v: number) => `${Math.round(v * 100)}%`} contentStyle={{ background: '#111118', border: '1px solid #27272a', color: '#e4e4e7' }} />
                <Legend wrapperStyle={legendStyle} />
          ...
          <div className="h-80">
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={monthlyPayments} margin={chartMargin}>
                ...
                />
                <Legend wrapperStyle={legendStyle} />
                <Bar dataKey="pmt" fill="#3f3f46" radius={[6, 6, 0, 0]}>
                  <LabelList
                    dataKey="pmt"
                    position="top"
                    formatter={(label: React.ReactNode) =>
          ...
          <div className="h-80">
            ...
            <ResponsiveContainer width="100%" height="100%">
              <ScatterChart margin={{ left: 8, right: 8, top: 8, bottom: 8 }}>
                ...
                <Tooltip cursor={{ strokeDasharray: "3 3" }} contentStyle={{ background: '#111118', border: '1px solid #27272a', color: '#e4e4e7' }} />
                {[0, 1, 2].map((c) => (
                  <Scatter
                    key={c}
                    name={`Cluster ${c}`}
      ...
      <section className="page-center mt-20 mb-24">
        <div className="rounded-2xl border border-cyan-400/20 bg-gradient-to-br from-zinc-900 via-cyan-950/25 to-zinc-950 p-8 shadow-sm text-center">
          ...
          <div className="mt-6 flex justify-center gap-4">
            <a
              href="/Intrepid_Star_Final.pdf"
              className="rounded-xl border-2 border-sky-400 px-5 py-2 text-cyan-400 hover:bg-sky-50 font-semibold shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-400 transition"
            >
              View STAR Deck
            </a>
            <a
